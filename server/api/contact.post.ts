export default defineEventHandler(async (event) => {
  try {
    ...
    // Use the nodemailer composable from the module
    const nodemailer = useNodeMailer();

    await nodemailer.sendMail({
      to: process.env.NUXT_NODEMAILER_FROM,
      replyTo: email,
                ...
                <tr>
                        ...
                        <td style="padding: 18px 20px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #667eea;">
                            ...
                            <tr>
                                ...
                                <p style="margin: 4px 0 0 0;">
                                    <a href="mailto:${email}" style="font-size: 16px; color: #667eea; text-decoration: none; font-weight: 500;">${email}</a>
                                </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <p style="margin: 4px 0 0 0; font-size: 16px; color: #111827; font-weight: 500;">${subject}</p>
                                </td>
                            </tr>
                            </table>
                        </td>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td style="padding: 20px; background: #f9fafb; border-radius: 8px; border: 1px solid #e5e7eb;">
                            <p style="margin: 0; font-size: 15px; line-height: 1.7; color: #374151; white-space: pre-line;">${message.replace(
                              /\n/g,
                              "<br>"
                            )}</p>
                        </td>
